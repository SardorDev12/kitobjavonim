...
export const PRIVACY_POLICY: Record<Locale, LegalDoc> = {
  en: {
    ...
    intro:
      'Shelfie ("we", "the app") helps you catalog the books you own and, if you choose, exchange or sell copies with other readers. This page explains what information we collect, why, and who can see it.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          'Shelfie is not directed at children under 13, and we do not knowingly collect information from them.',
        ],
      },
      {
  ...
  ru: {
    ...
    intro:
      'Shelfie («мы», «приложение») помогает вести каталог ваших книг и, по желанию, обмениваться или продавать экземпляры другим читателям. Здесь описано, какие данные мы собираем, зачем и кто их видит.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          'Shelfie не предназначен для детей младше 13 лет, и мы сознательно не собираем данные от них.',
        ],
      },
      {
        heading: 'Ваш выбор',
  ...
  uz: {
    ...
    intro:
      'Shelfie ("biz", "ilova") sizga oʻz kitoblaringiz katalogini yuritish va xohlasangiz, ularni boshqa oʻquvchilar bilan almashish yoki sotish imkonini beradi. Ushbu sahifada qanday maʼlumot yigʻishimiz, nima uchun va kim koʻra olishi tushuntirilgan.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          'Shelfie 13 yoshdan kichik bolalarga moʻljallanmagan va biz ulardan ataylab maʼlumot yigʻmaymiz.',
        ],
      },
      {
...
export const TERMS_OF_SERVICE: Record<Locale, LegalDoc> = {
  en: {
    ...
    updated: `Last updated: ${LAST_UPDATED}`,
    intro:
      'These terms govern your use of Shelfie. By creating an account or using the app, you agree to them.',
    sections: [
      {
        heading: 'The service',
        body: [
          'Shelfie lets you catalog the books you own and, if you choose, list copies for exchange or sale so other readers can find and contact you about them.',
  ...
  ru: {
    ...
    updated: `Последнее обновление: ${LAST_UPDATED}`,
    intro:
      'Эти условия регулируют использование Shelfie. Создавая аккаунт или используя приложение, вы соглашаетесь с ними.',
    sections: [
      {
        heading: 'Сервис',
        body: [
          'Shelfie позволяет вести каталог ваших книг и, по желанию, выставлять экземпляры на обмен или продажу, чтобы другие читатели могли найти их и связаться с вами.',
  ...
  uz: {
    ...
    updated: `Oxirgi yangilanish: ${LAST_UPDATED}`,
    intro:
      "Ushbu shartlar Shelfie'dan foydalanishingizni tartibga soladi. Hisob yaratish yoki ilovadan foydalanish orqali siz ularga rozilik bildirasiz.",
    sections: [
      {
        heading: 'Xizmat',
        body: [
          'Shelfie sizga oʻz kitoblaringiz katalogini yuritish va xohlasangiz, boshqa oʻquvchilar topib, siz bilan bogʻlanishi uchun nusxalarni almashish yoki sotishga qoʻyish imkonini beradi.',
