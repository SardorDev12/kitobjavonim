...
export const ru: LocaleCatalogue = {
  ...
  'library.noResultsAddBody': 'Похоже, этой книги ещё нет в вашей библиотеке.',
  'library.noResultsAddCta': 'Добавить эту книгу',
  ...
  'book.startedOn': 'Начата {{date}}',
  'book.progress': 'Прогресс',
  'book.progressEmpty': 'Прогресс пока не отмечен',
  'book.progressPageOf': 'Страница {{page}} из {{total}} ({{percent}}%)',
  'book.progressPercent': 'Прочитано {{percent}}%',
  'book.progressEstimate': 'Осталось примерно {{days}} дней в этом темпе',
  'book.progressEstimate_one': 'Остался примерно {{days}} день в этом темпе',
  'book.progressEstimate_few': 'Осталось примерно {{days}} дня в этом темпе',
  'book.progressEstimate_many': 'Осталось примерно {{days}} дней в этом темпе',
  ...
  'book.newCategory': 'Новая',
  'book.newCategoryPlaceholder': 'Название категории',
  ...
  'reading.rereadTitle': 'Прочитать снова?',
  'reading.rereadBody': 'Вы уже закончили «{{title}}». Начать чтение заново?',
  'reading.rereadConfirm': 'Читать снова',
  ...
  'wishlist.matchContinue': 'Продолжить',

  'household.title': 'Семья',
  'household.subtitle': 'Делитесь полками с теми, с кем живёте.',
  'household.create': 'Создать семью',
  'household.createBody': 'Создайте общую библиотеку. Потом сможете пригласить остальных.',
  'household.join': 'Присоединиться к семье',
  'household.joinBody': 'Есть код приглашения от того, с кем вы живёте? Введите его здесь.',
  'household.nameLabel': 'Название семьи',
  'household.namePlaceholder': 'например, Семья Каримовых',
  'household.codeLabel': 'Код приглашения',
  'household.inviteCode': 'Код приглашения',
  'household.inviteCodeHint': 'Поделитесь этим кодом с тем, с кем живёте, чтобы он мог присоединиться.',
  'household.regenerateCode': 'Создать новый код',
  'household.members': 'Участники',
  'household.you': 'вы',
  'household.roleOwner': 'Владелец',
  'household.roleMember': 'Участник',
  'household.unnamedMember': 'Без имени',
  'household.leave': 'Покинуть семью',
  'household.leaveConfirm':
    'Покинуть эту семью? Добавленные вами общие книги останутся общими для остальных, а их книги вы больше не увидите.',
  'household.remove': 'Удалить',
  'household.removeConfirm': 'Удалить {{name}} из семьи?',
  'household.share': 'Поделиться',
  ...
  'import.rowCount': '{{count}} книг найдено',
  'import.rowCount_one': '{{count}} книга найдена',
  'import.rowCount_few': '{{count}} книги найдено',
  'import.rowCount_many': '{{count}} книг найдено',
  'import.rowCount_other': '{{count}} книг найдено',
  'import.detectedColumns': 'Обнаруженные столбцы',
  'import.field.title': 'Название',
  'import.field.status': 'Статус',
  'import.field.author': 'Автор',
  'import.field.publisher': 'Издательство',
  'import.field.startDate': 'Дата начала',
  'import.field.endDate': 'Дата окончания',
  'import.field.rating': 'Оценка',
  'import.field.review': 'Отзыв',
  'import.field.pages': 'Страницы',
  'import.field.collection': 'Коллекция',
