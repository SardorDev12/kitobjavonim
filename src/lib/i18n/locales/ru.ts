...
export const ru: LocaleCatalogue = {
  ...
  'error.listingLimitReached': 'Вы достигли лимита бесплатного плана на активные объявления. Уберите одно или перейдите на Pro — раздел «Ваш план» в настройках.',
  'error.contactLimitReached': 'Вы достигли лимита бесплатного плана на контакты с владельцами в этом месяце. Лимит обновится в следующем месяце, или перейдите на Pro — раздел «Ваш план» в настройках.',
