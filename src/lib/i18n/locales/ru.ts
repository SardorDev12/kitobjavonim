...
export const ru: LocaleCatalogue = {
  ...
  'library.selectedCount_many': 'Выбрано: {{count}}',
  'library.selectedCount_other': 'Выбрано: {{count}}',
  'library.shareWithFamily': 'Поделиться с семьёй',
  'library.deleteSelected': 'Удалить',
  'library.deleteSelectedConfirm': 'Удалить {{count}} книг?',
  'library.deleteSelectedConfirm_one': 'Удалить эту книгу?',
  ...
  'book.locationPlaceholder': 'например, верхняя полка, гостиная',
  ...
  'household.copyCode': 'Скопировать код',
  'household.codeCopied': 'Код скопирован в буфер обмена.',
  'household.shareMessage': 'Присоединяйтесь к «{{name}}» в Shelfie — перейдите по ссылке, чтобы войти и сразу присоединиться.',

  'join.invalidCode': 'В этой ссылке-приглашении нет кода.',
  'join.title': 'Вас пригласили',
  'join.subtitle': 'Присоединитесь к общей семейной библиотеке в Shelfie.',
  'join.joining': 'Присоединяемся…',
  'join.joinedTitle': 'Готово!',
  'join.joinedBody': 'Вы присоединились к семье.',
  'join.viewHousehold': 'Перейти к семье',
  'join.errorTitle': 'Не удалось присоединиться',
  'join.goToHousehold': 'Перейти к семье',
  'join.signUpPrompt': 'Войдите, чтобы присоединиться по этому коду.',
  'join.createAccount': 'Создать аккаунт',
  'join.signIn': 'У меня уже есть аккаунт',
