...
export const uz: LocaleCatalogue = {
  ...
  'library.shareWithFamily': "Oila bilan bo'lishish",
  'library.deleteSelected': "O'chirish",
  ...
  'book.locationPlaceholder': 'masalan, yuqori tokcha, mehmonxona',
  ...
  'household.copyCode': 'Kodni nusxalash',
  'household.codeCopied': 'Kod nusxalandi.',
  'household.shareMessage': '«{{name}}»ga Shelfie’da qoʻshiling — havolani bosing, tizimga kirasiz va avtomatik qoʻshilasiz.',

  'join.invalidCode': 'Bu taklif havolasida kod yoʻq.',
  'join.title': 'Sizni taklif qilishdi',
  'join.subtitle': "Shelfie’da umumiy oilaviy kutubxonaga qoʻshiling.",
  'join.joining': 'Qoʻshilyapti…',
  'join.joinedTitle': 'Tayyor!',
  'join.joinedBody': 'Siz oilaga qoʻshildingiz.',
  'join.viewHousehold': "Oilani ko'rish",
  'join.errorTitle': 'Qoʻshib boʻlmadi',
  'join.goToHousehold': 'Oilaga oʻtish',
  'join.signUpPrompt': 'Bu kod bilan qoʻshilish uchun tizimga kiring.',
  'join.createAccount': 'Hisob yaratish',
  'join.signIn': 'Hisobim bor',
