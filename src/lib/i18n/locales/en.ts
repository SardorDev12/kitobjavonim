...
export const en = {
  ...
  'library.shareWithFamily': 'Share with family',
  'library.deleteSelected': 'Delete',
  ...
  'book.progressEmpty': 'No progress logged yet',
  'book.progressPageOf': 'Page {{page}} of {{total}} ({{percent}}%)',
  'book.progressPercent': '{{percent}}% complete',
  'book.progressEstimate': '~{{days}} days left at this pace',
  'book.progressEstimate_one': '~{{days}} day left at this pace',
  ...
  'book.newCategory': 'New',
  'book.newCategoryPlaceholder': 'Category name',
  ...
  'reading.rereadTitle': 'Read again?',
  'reading.rereadBody': 'You already finished "{{title}}". Start reading it again?',
  'reading.rereadConfirm': 'Read again',
  ...
  'wishlist.matchContinue': 'Continue',
  ...
  'household.shareMessage': 'Join {{name}} on Shelfie — tap the link to sign in and join automatically.',

  'join.invalidCode': 'This invite link is missing its code.',
  'join.title': "You're invited",
  'join.subtitle': 'Join a shared family library on Shelfie.',
  'join.joining': 'Joining…',
  'join.joinedTitle': "You're in!",
  'join.joinedBody': "You've joined the household.",
  'join.viewHousehold': 'View household',
  'join.errorTitle': "Couldn't join",
  'join.goToHousehold': 'Go to household',
  'join.signUpPrompt': 'Sign in to join with this code.',
  ...
  'import.rowCount': '{{count}} books found',
  'import.rowCount_one': '{{count}} book found',
  'import.rowCount_other': '{{count}} books found',
  'import.detectedColumns': 'Columns detected',
  'import.field.title': 'Title',
  'import.field.status': 'Status',
  'import.field.author': 'Author',
  'import.field.publisher': 'Publisher',
  'import.field.startDate': 'Start date',
  'import.field.endDate': 'End date',
  'import.field.rating': 'Rating',
  'import.field.review': 'Review',
  'import.field.pages': 'Pages',
  'import.field.collection': 'Collection',
